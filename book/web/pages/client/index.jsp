    ...
    <script type="text/javascript">
        $(function () {
            $("button.addToCart").click(function () {
                var bookId = $(this).attr("bookId");//取出自定义属性的值
                $.getJSON("<%=request.getContextPath()%>"+"/cartServlet","action=addItem&id="+bookId,function (data) {
                    $("#cartLastName").text("您刚刚把"+data.lastName+"加入了购物车");
...
<div id="header">
    ...
    <div>
        ...
        <c:if test="${not empty sessionScope.user}">
            <span>欢迎<span class="um_span">${sessionScope.user.username}</span>欢迎光临王汉桑商城</span>
    ...
    <div id="book">
        ...
        <div style="text-align: center">
            <c:if test="${empty sessionScope.cart.totalCount}">
                ...
                <div><span id="cartLastName">当前购物车为空</span></div>
            </c:if>
